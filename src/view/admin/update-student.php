...
<div class="main-content">
    <div class="wrapper">
        ...
        ?>
        <div class="container">
            <form method="POST" action="update-student.php?st_id=<?php echo $id ?>">
                Tên: <input class="form-control" type="text" name="ten" value="<?php echo $st['st_ten'] ?>" /><br>
                Số điện thoại: <input class="form-control" type="text" name="sdt" value="<?php echo $st['st_sdt'] ?>" /><br>
                Email: <input class="form-control" type="text" name="email" value="<?php echo $st['st_email'] ?>" /><br>
                Địa chỉ: <input class="form-control" type="text" name="diachi" value="<?php echo $st['st_diachi'] ?>" /><br>
                <br>
