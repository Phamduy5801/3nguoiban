...
if (isset($_REQUEST['id']) && isset($_REQUEST['khoa']) && isset($_REQUEST['ten']) && isset($_REQUEST['ngay_batdau']) && isset($_REQUEST['ngay_ketthuc']) && isset($_REQUEST['thoigian_hoc']) && isset($_REQUEST['so_tc'])) {

    //kết nối sql
    include_once ("../../config/config.php");
    //câu lệnh sql
    $query = "INSERT INTO `db_subject` (`sb_id`,`ma_khoa`,`sb_ten`,`ngay_batdau`,`ngay_ketthuc`,`thoigian_hoc`,`sb_tinchi`) VALUES (?,?,?,?,?,?,?);";
    ...
    $stmt->bind_param('ssssssd', $id, $khoa, $ten, $ngay_bd, $ngay_kt, $thoigian_hoc, $so_tc);
