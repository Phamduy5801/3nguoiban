...
<div class="main-content">
    <div class="wrapper">
        <h1 style="color:#a83232">Cập nhật thông tin giảng viên</h1>
        <br>
        <?php
        ...
        ?>
        <div class="container">
            <form method="POST" action="dexuat-sua-teacher.php?tea_id=<?php echo $id ?>">
                Tên: <input class="form-control" type="text" readonly name="ten" value="<?php echo $tea['tea_ten'] ?>" /><br>
                ...
                Địa chỉ: <input class="form-control" readonly type="text" name="diachi" value="<?php echo $tea['tea_diachi'] ?>" /><br>
                <br>
