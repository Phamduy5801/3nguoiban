    ...
    <div class="wrapper">
        ...
        <table class="table table-striped">
            <thead class="table-dark">
                ...
                //câu lệNh sql
                $query = "Select s.sb_id,k.ten_khoa, s.sb_ten,s.ngay_batdau, s.ngay_ketthuc, s.thoigian_hoc, t.tea_ten, s.sb_tinchi, s.sb_tb   from db_subject s, db_khoa k, db_teacher t, teacher_subject ts
