        ...
        <div class="wrapper">
            ...
            <table class="table table-bordered" style="border: solid;">
                ...
                <tbody>
                    ...
                    $sql = "select id, db_dkihoc.sb_id, db_dkihoc.st_id, ngay_dki 
                    from db_dkihoc, db_user, db_student 
                    where db_dkihoc.st_id = db_student.st_id and db_student.user_id = db_user.user_id and db_user.username = '$username'";
